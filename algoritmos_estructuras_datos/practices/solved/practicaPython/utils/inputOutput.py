...
def read_mouse_from_keyboard():
  ...
  mouse = Mouse.Mouse(name=name, birthdate=birthdate, weight=weight, gender=gender, temperature=temperature, description=description,  chromosome1=chromosome1, chromosome2=chromosome2)
  return mouse
