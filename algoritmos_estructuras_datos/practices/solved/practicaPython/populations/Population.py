...
class Population: 
  ...
  def __init__(self, reference=None, name=None, researcher=None, start_date=date.today(), num_days=270, animal_list=None, families_list=None, population_size = 10, male_percentage=0.4, mutated_percentage=0.2):
  ...
  @staticmethod
  def __generate_random_mouses(population_size, male_percentage, mutated_percentage):
    '''
